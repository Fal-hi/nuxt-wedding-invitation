      ...
      <div v-if="showContent" id="content">
        ...
        <footer class="section relative overflow-hidden text-center">
          <div class="pointer-events-none absolute inset-0">
            <div
              class="absolute right-10 top-8 h-28 w-28 transform-gpu rounded-full bg-white/30 blur-3xl"
            ></div>
            <div
              class="absolute bottom-8 left-16 h-32 w-32 transform-gpu rounded-full bg-white/30 blur-3xl"
            ></div>
          </div>

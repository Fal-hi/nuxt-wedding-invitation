...
const addAccount = async () => {
  if (!newBankName.value || !newAccountNumber.value || !newAccountHolder.value) return;
  isAdding.value = true;
  ...
  <div class="bg-white px-4 py-5 shadow sm:rounded-lg sm:p-6">
    ...
    <div v-else class="space-y-8">
      ...
      <div class="rounded-lg border border-gray-200 bg-gray-50 p-4">
        <h3 class="mb-4 text-md font-medium text-gray-900">
          Tambahkan Rekening Baru
        </h3>
        <form
          @submit.prevent="addAccount"
          class="grid grid-cols-1 gap-4 sm:grid-cols-12 items-end"
        >
          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="divide-y divide-gray-200 bg-white">
              ...
              >
                ...
                <td
                  class="whitespace-nowrap px-6 py-4 font-mono text-sm text-gray-900"
                >
